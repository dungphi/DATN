	...
	<div class="row">
    	<div class="col-sm-8 col-md-8 ">
            <div class=" row thong-tin">
                <div class="col-sm-6 col-md-6">
                    ...
                    <h4><label><i class="fa fa-signal fa-lg fa-fw "></i> <b>Kinh nghiệm: </label><?=$thongtin['ten_kn']; ?></h4>
        ...
        <div class="col-sm-4 col-md-4">
        	<div class="avatar">
                ...
                <div class="tt-phu">
                    <label><i class="fa fa-birthday-cake fa-fw "></i> Ngày sinh:</label> <?=date('d-m-Y', strtotime($thongtin['ngay_sinh'])); ?>
