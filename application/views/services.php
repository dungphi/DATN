...
<html>
<head>
<title>Quamax A Web Hosting Category Flat Bootstarp Resposive Website Template | Services :: w3layouts</title>
...
<!-- services -->
	<div class="services">
		<div class="container">
			<h3>CUSTOM HOST SERVICES INFORMATION</h3>
			<div class="feature-top">
				<div class="col-md-6 ser-top">
				<div class="ser-btm">
					<div class="ser-lft">
			...
			<div class="fe-btom">
				...
				<h3>FEATURED SERVICES</h3>
					<div class="about-top">
						...
						<p>Dolor nunc vule putateulr ips dol consec. Donec semp ertet laciniate ultricie putateulr ips dol consec. Donec semp ertet laciniate putateulr putateulr ips dol consec. Donec semp ertet laciniate ips dol consec. Donec semp ertet laciniate upien disseco dolo lectus fgilla itollicil tua ludin dolor nec met quam accumsan dolorecondime netus lulam utlacus adipiscing ipsu Aenean imperdiet alique.</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="about-top">
						...
						<div class="ab-rgt">
						<h4>Vule putateulr ips dol consec</h4>
						<p>Dolor nunc vule putateulr ips dol consec. Donec semp putateulr ips dol consec. Donec putateulr ips dol consec. Donec semp ertet laciniate semp putateulr ips dol consec. Donec semp ertet laciniate ertet laciniate ertet laciniate ultricie upien disseco dolo lectus fgilla itollicil tua ludin dolor nec met quam accumsan dolorecondime netus lulam utlacus adipiscing ipsu Aenean imperdiet alique.</p>
						</div>
						<div class="clearfix"> </div>
					</div>
				</div>
				<div class="col-md-4 fe-bt-lft">
				<h3>SERVICES LIST</h3>
				<ul>
