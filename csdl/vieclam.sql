...
-- Thời gian đã tạo: Th10 08, 2017 lúc 01:18 PM
...
INSERT INTO `ho_so_tim_viec` (`id`, `id_ntv`, `vip`, `tieu_de`, `nganh_nghe`, `kinh_nghiem`, `ngay_dk`, `muc_luong`) VALUES
...
INSERT INTO `nguoi_tim_viec` (`id`, `ho`, `ten`, `email`, `phone`, `ngay_sinh`, `dia_chi`, `bang_cap`, `avatar`, `chung_chi`, `gioi_tinh`, `active`, `pass`) VALUES
